...
export default function RegisterPage() {
  return (
    <div className="relative flex min-h-screen w-full">
      <div className="mesh-bg pulse-mesh relative hidden w-1/2 items-center justify-center overflow-hidden p-10 lg:flex">
        ...
        <div className="relative z-10 flex h-full w-full max-w-lg flex-col justify-between">
          ...
          <div className="space-y-6">
            ...
            <p className="max-w-md text-lg text-on-surface-variant">
              Create an account and access fleet orchestrations, drivers logs,
              dispatch boards, maintenance workflows, and robust financial
              insights.
            </p>
          </div>
        ...
        <div className="glass-panel w-full max-w-md rounded-3xl p-8 md:p-10">
          <div className="mb-8 text-center lg:text-left">
            ...
            <p className="text-on-surface-variant text-sm">
              Register a new operator profile with TransitOps.
            </p>
          </div>
